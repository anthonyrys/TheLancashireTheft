...
public class Vase extends Room {
    public Vase() {
        super("Vase", "the vase was shattered by an object of some sort. ");
    ...
    @Override
    public void a() {
        scene.displayNotification("the antique is most likely what shattered this vase. ");
    }
