...
public class Exhibit extends Room {
    public Exhibit() {
        super("Exhibit", "you notice the shards of the broken vase on the ground. ");
        this.buttonNames = new String[]{"approach the empty stand", "investigate the broken vase", "back"};
    ...
    public void a() {
        ...
        this.transition(Room.getRoom("Stand", this.player, this.scene));
    }

    @Override
    public void b() {
        this.deactivateButtons();
        this.transition(Room.getRoom("Vase", this.player, this.scene));
    }
