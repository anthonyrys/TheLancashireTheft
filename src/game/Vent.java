...
public class Vent extends Room {
    public Vent() {
        super("Vent", "you notice the vent was hastily screwed back in. ");
        this.buttonNames = new String[]{"???-unscrew the vent-screwdriver", "back"};
    ...
    @Override
    public void a() {
        if (this.player.getItem("antique")) {
            this.scene.displayNotification("you find nothing else. ");
            return;
        }

        scene.displayNotification("you find the antique that was missing from its stand. ");
        this.player.addItem(new Item("antique", "the reported missing item"));
    }
