...
public class Storageroom extends Room {
    public Storageroom() {
        super("Storageroom", "maybe you can find something of use in here. ");
        this.buttonNames = new String[]{"search crates", "search drawers", "back"};
    ...
    @Override
    public void a() {
        if (this.player.getItem("screwdriver")) {
            this.scene.displayNotification("you find nothing else. ");
            return;
        }

        this.scene.displayNotification("you find a used screwdriver");
        this.player.addItem(new Item("screwdriver", "used, but still functional"));
    }

    @Override
    public void b() {
        if (this.player.getItem("monocle")) {
            this.scene.displayNotification("you find nothing else. ");
            return;
        }

        this.scene.displayNotification("you find an expensive monocle");
        this.player.addItem(new Item("monocle", "carved with the initials A.T."));
    }

    @Override
    public void c() {
        this.deactivateButtons();
        this.transitionReverse(Room.getRoom("Lobby", this.player, this.scene));
    }
}