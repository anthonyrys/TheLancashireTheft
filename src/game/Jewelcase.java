...
public class Jewelcase extends Room {
    public Jewelcase() {
        super("Jewelcase", "the case is in perfect condition, though the jewel is missing.");
    ...
    public void update(boolean type) {
        this.player.addItem(new Item("jewel case", "in perfect condition"));
