...
public class Bathroom extends Room {
    public Bathroom() {
        super("Bathroom", "you notice a vent has been tampered with. ");
        this.buttonNames = new String[]{"investigate the vent", "investigate the sink", "back"};
    ...
    public void a() {
        ...
        this.transition(Room.getRoom("Vent", this.player, this.scene));
    }

    @Override
    public void b() {
        this.deactivateButtons();
        this.transition(Room.getRoom("Sink", this.player, this.scene));
    }
